...
<head>
    ...
    <style>
        ...
        #content {
            font: normal normal 1em/1.5em "Helvetica Neue", Helvetica, Arial, sans-serif;
            margin: 0 40px 10px;
        }
    ...
    <script>
        ...
        var quiz = [
            ...
            ?> {
                    ...
                    "correct": "<?php echo $row->correct; ?>",
                    "explanation": "<?php echo $row->explanation; ?>",
        ...
        function loadQuestion() {
            ...
            for (var i = 0; i < quiz[currentQuestion]["choices"].length; i++) {
                ...
                label.style.border="border: 1px solid red";
    ...
    // text-transform: uppercase
                ...
                document.getElementById('content').insertBefore(br, list.childNodes[0]);
